...
<head>
    ...
    <title>PDAM | <?php echo $title ?></title>
        ...
        <aside class="main-sidebar sidebar-blue-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item <?php if (in_array($activeMenu, ['suratmasuk', 'suratkeluar', 'disposisi'])) echo "menu-open" ?>">
                            <a href="#" class="nav-link <?php if (in_array($activeMenu, ['suratmasuk', 'suratkeluar', 'disposisi'])) {
                                                            echo "active";
                                                        } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo site_url('suratmasuk/') ?>" class="nav-link <?php if ($activeMenu == 'suratmasuk') echo "active"; ?>">
                                        <i class="nav-icon far fa-envelope-open"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo site_url('suratkeluar/') ?>" class="nav-link <?php if ($activeMenu == 'suratkeluar') echo "active"; ?>">
                                        <i class="nav-icon far fa-envelope-open"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('about/') ?>" class="nav-link <?php if ($activeMenu == 'about') echo "active"; ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('contact/') ?>" class="nav-link <?php if ($activeMenu == 'contact') echo "active"; ?>">
